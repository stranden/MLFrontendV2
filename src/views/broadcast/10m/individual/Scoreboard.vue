    ...
    <div class="w-[60vw] h-[60vh] flex justify-center">
      <div class="bg-white/50 rounded-lg h-full w-full flex flex-col px-[2vw] py-[2vh]">
        ...
        <div class="w-full">
          ...
          >
            <!-- Rank -->
            <div class="flex items-center justify-center rounded-full bg-[#00004b] text-[#e6e6e6] font-bold text-[2vmin] w-[3vmin] h-[3vmin]">
              {{ participant.rank }}
            </div>

            <!-- Name + Nation -->
            <div class="flex items-center gap-[1vmin]">
              <span class="nation h-[3vmin] w-[3vmin] rounded-[25%]">{{ participant.club }}</span>
              <span class="font-bold text-[2vmin] text-[#333]">{{ participant.name }}</span>
            </div>

            <!-- Total Score -->
            <div class="flex items-center justify-center text-[2vmin] font-bold text-[#e6e6e6]">
              <div class="flex items-center justify-center bg-[#00004b] w-[10vmin] h-[3vmin] rounded-[1.5vmin]">
                {{ participant.totalScore }}
              </div>
            </div>

            <!-- Notes -->
             <div class="inline-flex items-center bg-[rgba(0,0,75,0.825)] h-[3vmin] rounded-[1.5vmin] w-full">
              <div class="w-full text-center font-bold text-[#888] text-[2vmin]">
                <span class="font-bold text-[#888] text-[2vmin]">
                  SCORE
                </span>
              </div>
            </div>
