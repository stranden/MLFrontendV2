...
<template>
  <div class="fixed bottom-[2.25vh] left-1/2 -translate-x-1/2 z-10 flex items-center bg-[#00004b] px-[0.5vw] py-[0.25vh] rounded-[1vw] text-white text-[1.5vw] w-fit mx-auto gap-[0.25vw] shadow-[0_0.5vh_2vh_rgba(0,0,0,0.2)]">
